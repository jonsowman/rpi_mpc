 ...
 */
#define EMLRT_VERSION_R2014B 0x2014B
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2014B
...
extern int emlrtMexPrintf(const char *aFmt, ...);
 ...
 */
EXTERN_C LIBEMLRT_API int emlrtGetErrorStatus(emlrtCTX aTLS);

/*
 * MATLAB INTERNAL USE ONLY :: Get Simulink coverage ID for the current block instance
 */
EXTERN_C LIBEMLRT_API uint32_T emlrtGetSimCovId(emlrtCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtImportCharArrayR2014b(emlrtCTX aTLS, const mxArray *aSrc, char_T *aDst, int32_T aNumel);

/*
 * MATLAB INTERNAL USE ONLY :: Import a character.
 */
EXTERN_C LIBEMLRT_API void emlrtImportCharR2014b(emlrtCTX aTLS, const mxArray *aSrc, char_T *aDst);
