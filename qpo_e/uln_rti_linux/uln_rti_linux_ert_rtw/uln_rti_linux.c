...
static void uln_rti_linux_multiply_LtDL(const real_T L[100], const real_T D[400],
  real_T Ac[25], real_T LtD[100]);
  ...
  real_T Ac[25], real_T LtD[100])
{
  ...
  memset(&Ac[0], 0, 25U * sizeof(real_T));
  memset(&LtD[0], 0, 100U * sizeof(real_T));
  for (i = 0; i < 5; i++) {
    c_j = i * (int32_T)4.0;
    for (c = 0; c <= 19 - c_j; c++) {
      b_k = c_j + c;
      LtD[i + 5 * b_k] = L[20 * i + b_k] * D[20 * b_k + b_k];
    }
  }
  ...
  for (i = 0; i < 5; i++) {
    for (c_j = 0; c_j < 5; c_j++) {
      c = c_j * (int32_T)4.0;
      for (b_k = 0; b_k <= 19 - c; b_k++) {
        k = c + b_k;
        Ac[i + 5 * c_j] += LtD[5 * k + i] * L[20 * c_j + k];
      }
    }
  }
}
...
void uln_rti_linux_step(void)
{
  ...
  int8_T rem_its;
  int8_T blk_i_nx[4];
  int8_T blk_i_nx_p1_sz[4];
  int8_T blk_i_nx_sz[4];
  real_T dgdz_blk[20];
  real_T JFk[144];
  real_T JFz[60];
  real_T k_irk[12];
  ...
  /* '<S3>:1:15' */
  memcpy(&rtb_znew[0], &uln_rti_linux_DW.z_store_DSTATE[0], 29U * sizeof(real_T));

  /* '<S3>:1:16' */
  memset(&rtb_C[0], 0, 80U * sizeof(real_T));

  /* '<S3>:1:17' */
  memset(&rtb_E[0], 0, 100U * sizeof(real_T));
  ...
  for (i = 0; i < 29; i++) {
    /* '<S3>:1:63' */
    /* '<S3>:1:64' */
    B[i] = uln_rti_linux_ConstP.Constant12_Value[29 * i + i] *
  ...
  for (b_i = 0; b_i < 5; b_i++) {
    ...
    /* '<S3>:1:71' */
    b_i_0 = (int8_T)(b_i * (int32_T)4.0);
    blk_i_nx[0] = (int8_T)(1 + b_i_0);
    blk_i_nx[1] = (int8_T)(2 + b_i_0);
    blk_i_nx[2] = (int8_T)(3 + b_i_0);
    blk_i_nx[3] = (int8_T)(4 + b_i_0);

    /*  equiv to myMat(bs(i,nx):be(i,nx)) */
    /* '<S3>:1:72' */
    b_i_0 = (int8_T)((b_i - 1) * (int32_T)4.0);
    blk_i_nx_m1_idx_0 = (int8_T)(1 + b_i_0);
    blk_i_nx_m1_idx_1 = (int8_T)(2 + b_i_0);
    blk_i_nx_m1_idx_2 = (int8_T)(3 + b_i_0);
    blk_i_nx_m1_idx_3 = (int8_T)(4 + b_i_0);

    /*  equiv to myMat(bs(i-1,nx):be(i-1,nx)) */
    /* '<S3>:1:73' */
    b_i_0 = (int8_T)((1 + b_i) * (int32_T)uln_rti_linux_sz);
    blk_i_nx_p1_sz[0] = (int8_T)(1 + b_i_0);
    blk_i_nx_p1_sz[1] = (int8_T)(2 + b_i_0);
    blk_i_nx_p1_sz[2] = (int8_T)(3 + b_i_0);
    blk_i_nx_p1_sz[3] = (int8_T)(4 + b_i_0);
    ...
    /* '<S3>:1:76' */
    b_i_0 = (int8_T)(b_i * (int32_T)uln_rti_linux_sz);
    blk_i_nx_sz[0] = (int8_T)(1 + b_i_0);
    blk_i_nx_sz[1] = (int8_T)(2 + b_i_0);
    blk_i_nx_sz[2] = (int8_T)(3 + b_i_0);
    blk_i_nx_sz[3] = (int8_T)(4 + b_i_0);
    ...
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_4[i_0] = (int8_T)((i_0 + i) + 1);
    }

    rtb_deltax0[0] = uln_rti_linux_DW.z_store_DSTATE[tmp_4[0] - 1];
    rtb_deltax0[1] = uln_rti_linux_DW.z_store_DSTATE[tmp_4[1] - 1];
    rtb_deltax0[2] = uln_rti_linux_DW.z_store_DSTATE[tmp_4[2] - 1];
    rtb_deltax0[3] = uln_rti_linux_DW.z_store_DSTATE[tmp_4[3] - 1];
    ...
    if (1 + b_i == 1) {
      ...
      /* '<S3>:1:115' */
      for (i_0 = 0; i_0 < 4; i_0++) {
        rtb_C[(blk_i_nx[0] + 20 * i_0) - 1] = dgdz_blk[i_0 << 2];
        rtb_C[(blk_i_nx[1] + 20 * i_0) - 1] = dgdz_blk[(i_0 << 2) + 1];
        rtb_C[(blk_i_nx[2] + 20 * i_0) - 1] = dgdz_blk[(i_0 << 2) + 2];
        rtb_C[(blk_i_nx[3] + 20 * i_0) - 1] = dgdz_blk[(i_0 << 2) + 3];
      }
    } else {
      /* '<S3>:1:117' */
      for (i_0 = 0; i_0 < 4; i_0++) {
        rtb_C_0[i_0 << 2] = rtb_C[(20 * i_0 + blk_i_nx_m1_idx_0) - 1];
        rtb_C_0[1 + (i_0 << 2)] = rtb_C[(20 * i_0 + blk_i_nx_m1_idx_1) - 1];
        rtb_C_0[2 + (i_0 << 2)] = rtb_C[(20 * i_0 + blk_i_nx_m1_idx_2) - 1];
        rtb_C_0[3 + (i_0 << 2)] = rtb_C[(20 * i_0 + blk_i_nx_m1_idx_3) - 1];
      }

      for (i_0 = 0; i_0 < 4; i_0++) {
        for (i_2 = 0; i_2 < 4; i_2++) {
          rtb_C[(blk_i_nx[i_0] + 20 * i_2) - 1] = 0.0;
          rtb_C[(blk_i_nx[i_0] + 20 * i_2) - 1] += rtb_C_0[i_2 << 2] *
            dgdz_blk[i_0];
          rtb_C[(blk_i_nx[i_0] + 20 * i_2) - 1] += rtb_C_0[(i_2 << 2) + 1] *
            dgdz_blk[i_0 + 4];
          rtb_C[(blk_i_nx[i_0] + 20 * i_2) - 1] += rtb_C_0[(i_2 << 2) + 2] *
            dgdz_blk[i_0 + 8];
          rtb_C[(blk_i_nx[i_0] + 20 * i_2) - 1] += rtb_C_0[(i_2 << 2) + 3] *
            dgdz_blk[i_0 + 12];
        }
      }
    }
    ...
    /*  And E diagonals */
    /* '<S3>:1:120' */
    rtb_E[(blk_i_nx[0] + 20 * b_i) - 1] = dgdz_blk[16];
    rtb_E[(blk_i_nx[1] + 20 * b_i) - 1] = dgdz_blk[17];
    rtb_E[(blk_i_nx[2] + 20 * b_i) - 1] = dgdz_blk[18];
    rtb_E[(blk_i_nx[3] + 20 * b_i) - 1] = dgdz_blk[19];
    ...
    for (i = 0; i < b_i; i++) {
      ...
      /* '<S3>:1:123' */
      /* '<S3>:1:124' */
      EtQbar_2 = rtb_E[(20 * i + blk_i_nx_m1_idx_0) - 1];
      unnamed_idx_1 = rtb_E[(20 * i + blk_i_nx_m1_idx_1) - 1];
      unnamed_idx_2 = rtb_E[(20 * i + blk_i_nx_m1_idx_2) - 1];
      unnamed_idx_3 = rtb_E[(20 * i + blk_i_nx_m1_idx_3) - 1];
      for (i_0 = 0; i_0 < 4; i_0++) {
        rtb_E[(blk_i_nx[i_0] + 20 * i) - 1] = 0.0;
        rtb_E[(blk_i_nx[i_0] + 20 * i) - 1] += dgdz_blk[i_0] * EtQbar_2;
        rtb_E[(blk_i_nx[i_0] + 20 * i) - 1] += dgdz_blk[i_0 + 4] * unnamed_idx_1;
        rtb_E[(blk_i_nx[i_0] + 20 * i) - 1] += dgdz_blk[i_0 + 8] * unnamed_idx_2;
        rtb_E[(blk_i_nx[i_0] + 20 * i) - 1] += dgdz_blk[i_0 + 12] *
          unnamed_idx_3;
      }
  ...
  for (i_0 = 0; i_0 < 20; i_0++) {
    ...
    for (i_2 = 0; i_2 < 29; i_2++) {
      rtb_w2[i_0] += uln_rti_linux_ConstP.Constant13_Value[(24 * i_2 + i_0) + 4]
  ...
  /*          end */
  /*      end */
  uln_rti_linux_multiply_LtDL(rtb_E, uln_rti_linux_ConstP.Constant21_Value,
    rtb_Ac, EtQbar);
  ...
  for (i_0 = 0; i_0 < 25; i_0++) {
    rtb_Ac[i_0] += uln_rti_linux_ConstP.Constant22_Value[i_0];
  }

  for (i_0 = 0; i_0 < 5; i_0++) {
    EtQbar_2 = 0.0;
    for (i_2 = 0; i_2 < 29; i_2++) {
      EtQbar_2 += uln_rti_linux_ConstP.Constant20_Value[5 * i_2 + i_0] *
        uln_rti_linux_DW.z_store_DSTATE[i_2];
    }
  ...
  /* '<S2>:1:14' */
  for (i_0 = 0; i_0 < 20; i_0++) {
    rtb_guA[i_0] = (((rtb_C[i_0 + 20] * rtb_deltax0[1] + rtb_C[i_0] *
                      rtb_deltax0[0]) + rtb_C[i_0 + 40] * rtb_deltax0[2]) +
                    rtb_C[i_0 + 60] * rtb_deltax0[3]) + (rtb_w2[i_0] + rtb_d[i_0]);
  ...
  for (i_0 = 0; i_0 < 5; i_0++) {
    for (i_2 = 0; i_2 < 29; i_2++) {
      ...
      for (i_1 = 0; i_1 < 20; i_1++) {
        tmp_1[i_0 + 5 * i_2] += rtb_E[20 * i_0 + i_1] *
          uln_rti_linux_ConstP.Constant13_Value[24 * i_2 + i_1];
      }
    }
  }
  ...
  for (i_0 = 0; i_0 < 5; i_0++) {
    ...
    for (i_2 = 0; i_2 < 20; i_2++) {
      EtQbar_0[i_0] += EtQbar[5 * i_2 + i_0] * rtb_d[i_2];
    }

    tmp_2[i_0] = 0.0;
    for (i_2 = 0; i_2 < 29; i_2++) {
      tmp_2[i_0] += tmp_1[5 * i_2 + i_0] * B[i_2];
    }
  }

  for (i_0 = 0; i_0 < 5; i_0++) {
    for (i_2 = 0; i_2 < 4; i_2++) {
      dgdz_blk[i_0 + 5 * i_2] = 0.0;
      for (i_1 = 0; i_1 < 20; i_1++) {
        dgdz_blk[i_0 + 5 * i_2] += EtQbar[5 * i_1 + i_0] * rtb_C[20 * i_2 + i_1];
      }
    }
  }
  ...
  for (i_0 = 0; i_0 < 5; i_0++) {
    EtQbar_2 = 0.0;
    for (i_2 = 0; i_2 < 29; i_2++) {
      EtQbar_2 += uln_rti_linux_ConstP.Constant20_Value[5 * i_2 + i_0] * B[i_2];
    }

    EtQbar_1[i_0] = (EtQbar_0[i_0] + tmp_2[i_0]) + EtQbar_2;
  }

  /* MATLAB Function: '<Root>/RTI_feedback' */
  for (i_0 = 0; i_0 < 5; i_0++) {
    EtQbar_2 = dgdz_blk[i_0 + 15] * rtb_deltax0[3] + (dgdz_blk[i_0 + 10] *
      rtb_deltax0[2] + (dgdz_blk[i_0 + 5] * rtb_deltax0[1] + dgdz_blk[i_0] *
                        rtb_deltax0[0]));
  ...
  rqp_run( (real_T*)&rtb_Ac[0], (real_T*)&rtb_Bc[0], (real_T*)&rtb_E[0], (real_T*)
          &rtb_gl[0], (real_T*)&rtb_gu[0], (real_T*)&rtb_glA[0], (real_T*)
          &rtb_guA[0], &rtb_RQP_wrp[0]);
  ...
  /* '<S1>:1:14' */
  for (i_0 = 0; i_0 < 5; i_0++) {
    EtQbar_0[i_0] = rtb_znew[(int32_T)uln_rti_linux_ConstP.Constant7_Value[i_0]
      - 1] + rtb_RQP_wrp[i_0];
  }

  for (i_0 = 0; i_0 < 5; i_0++) {
    rtb_znew[(int32_T)uln_rti_linux_ConstP.Constant7_Value[i_0] - 1] =
      EtQbar_0[i_0];
  }

  /* '<S1>:1:15' */
  for (i_0 = 0; i_0 < 20; i_0++) {
    dgdz_blk[i_0] = (((rtb_C[i_0 + 20] * rtb_deltax0[1] + rtb_C[i_0] *
                       rtb_deltax0[0]) + rtb_C[i_0 + 40] * rtb_deltax0[2]) +
                     rtb_C[i_0 + 60] * rtb_deltax0[3]) + (rtb_w2[i_0] +
      rtb_d[i_0]);
    tmp_3[i_0] = 0.0;
    for (i_2 = 0; i_2 < 5; i_2++) {
      tmp_3[i_0] += rtb_E[20 * i_2 + i_0] * rtb_RQP_wrp[i_2];
    }
  }

  for (i_0 = 0; i_0 < 20; i_0++) {
    rtb_znew[(int32_T)uln_rti_linux_ConstP.Constant8_Value[i_0] - 1] =
      dgdz_blk[i_0] + tmp_3[i_0];
  }
  ...
  /*  RTI step complete */
  for (i = 0; i < 5; i++) {
    uln_rti_linux_Y.uOpt[i] = rtb_znew[(int32_T)
      uln_rti_linux_ConstP.Constant7_Value[i] - 1];
  }

  /* End of Outport: '<Root>/uOpt' */

  /* Update for UnitDelay: '<Root>/z_store' */
  memcpy(&uln_rti_linux_DW.z_store_DSTATE[0], &rtb_znew[0], 29U * sizeof(real_T));
}
...
void uln_rti_linux_initialize(void)
{
  ...
  memcpy(&uln_rti_linux_DW.z_store_DSTATE[0],
         &uln_rti_linux_ConstP.z_store_InitialCondi[0], 29U * sizeof(real_T));
}
